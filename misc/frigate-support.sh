...
while [ -z "${CTID:+x}" ]; do
  CTID=$(whiptail --backtitle "Proxmox Scripts" --title "Containers on $NODE" --radiolist \
...
# bash -c "$(wget -qLO - https://github.com/DarkEngineer/Proxmox/raw/main/misc/frigate-support.sh)"
